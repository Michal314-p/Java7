...
public class Controller_B extends Thread implements Initializable {
    ...
    public void wyslij_wiadomosc() {
        ...
        try {
            SOAPMessage soapmessage = Obsluga_wiadomosci.tworzenie_wiadomosci(wiadomosc.getText(), odbiorca.getText(), String.valueOf(Czytnik_B.port_wlasciwy), typ_wiadomosci);
            Czytnik_B.przeslij(soapmessage);
