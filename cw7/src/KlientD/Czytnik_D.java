...
public class Czytnik_D extends Thread
{
    ...
    public static Controller_D controller_d;
    ...
    public Czytnik_D(String port_wlasciwy) {
    ...
    public void przeslij_unicast() throws SOAPException, IOException
    {
        ...
        {
            controller_d.pokaz_dane_diagnostyczne("Otrzymano wiadomość od " + nadawca_czytnik);
            controller_d.pokaz_wiadomosc(nadawca_czytnik + ": " + wiadomosc_czytnik);
        }  else if (!nadawca_czytnik.equals(port_wlasciwy)) {
            przeslij(soap_message_handler.getWiadomosc_SOAP());
            controller_d.pokaz_dane_diagnostyczne("Przekazano wiadomość od " + nadawca_czytnik + " do " + odbiorca_czytnik);
        }
    ...
    public void przeslij_broadcast() throws  SOAPException, IOException
    {
        ...
        {
            controller_d.skrzynka_odbiorcza.getItems().add(wiadomosc_czytnik);
            controller_d.pokaz_dane_diagnostyczne("Otrzymano wiadomość od " + nadawca_czytnik);
            controller_d.pokaz_wiadomosc(nadawca_czytnik + ": " + wiadomosc_czytnik);
