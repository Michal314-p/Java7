...
public class Czytnik_C extends Thread
{
    ...
    public static Controller_C controller_c;
    ...
    public Czytnik_C(String port_wlasciwy) {
    ...
    public void przeslij_unicast() throws SOAPException, IOException
    {
        ...
        {
            controller_c.pokaz_dane_diagnostyczne("Otrzymano wiadomość od " + nadawca_czytnik);
            controller_c.pokaz_wiadomosc(nadawca_czytnik + ": " + wiadomosc_czytnik);
        }  else if (!nadawca_czytnik.equals(port_wlasciwy)) {
            przeslij(soap_message_handler.getWiadomosc_SOAP());
            controller_c.pokaz_dane_diagnostyczne("Przekazano wiadomość od " + nadawca_czytnik + " do " + odbiorca_czytnik);
        }
    ...
    public void przeslij_broadcast() throws  SOAPException, IOException
    {
        ...
        {
            controller_c.skrzynka_odbiorcza.getItems().add(wiadomosc_czytnik);
            controller_c.pokaz_dane_diagnostyczne("Otrzymano wiadomość od " + nadawca_czytnik);
            controller_c.pokaz_wiadomosc(nadawca_czytnik + ": " + wiadomosc_czytnik);
