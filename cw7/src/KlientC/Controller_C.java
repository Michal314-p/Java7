...
public class Controller_C extends Thread implements Initializable {
    ...
    public void wyslij_wiadomosc() {
        ...
        try {
            SOAPMessage soapmessage = Obsluga_wiadomosci.tworzenie_wiadomosci(wiadomosc.getText(), odbiorca.getText(), String.valueOf(Czytnik_C.port_wlasciwy), typ_wiadomosci);
            Czytnik_C.przeslij(soapmessage);
