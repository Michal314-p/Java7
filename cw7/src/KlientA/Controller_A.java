...
public class Controller_A extends Thread implements Initializable {
    ...
    public void wyslij_wiadomosc() {
        ...
        try {
            SOAPMessage soapmessage = Obsluga_wiadomosci.tworzenie_wiadomosci(wiadomosc.getText(), odbiorca.getText(), String.valueOf(Czytnik_A.port_wlasciwy), typ_wiadomosci);
            Czytnik_A.przeslij(soapmessage);
